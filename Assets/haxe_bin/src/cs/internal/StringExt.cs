...
namespace haxe.lang{
	public  class StringExt {
		public    StringExt(){
			unchecked {
				#line 26 "C:\\Haxe\\haxe\\std\\cs\\internal\\StringExt.hx"
				{
				}
		...
		public static   string toString(string me){
			unchecked {
				#line 181 "C:\\Haxe\\haxe\\std\\cs\\internal\\StringExt.hx"
				return me;
			}
			#line default
		}
		...
		public static   string toNativeString(string me){
			unchecked {
				#line 202 "C:\\Haxe\\haxe\\std\\cs\\internal\\StringExt.hx"
				return me;
			}
			#line default
		}
...
namespace haxe.lang{
	public  class StringRefl {
		static StringRefl() {
			#line 216 "C:\\Haxe\\haxe\\std\\cs\\internal\\StringExt.hx"
		...
		public    StringRefl(){
			unchecked {
				#line 214 "C:\\Haxe\\haxe\\std\\cs\\internal\\StringExt.hx"
				{
				}
		...
		public static   object handleGetField(string str, string f, bool throwErrors){
			unchecked {
				#line 220 "C:\\Haxe\\haxe\\std\\cs\\internal\\StringExt.hx"
				switch (f){
					case "length":
					{
						#line 222 "C:\\Haxe\\haxe\\std\\cs\\internal\\StringExt.hx"
						return str.Length;
					}
					...
					{
						#line 224 "C:\\Haxe\\haxe\\std\\cs\\internal\\StringExt.hx"
					...
					default:
					{
						#line 226 "C:\\Haxe\\haxe\\std\\cs\\internal\\StringExt.hx"
						if (throwErrors) {
							#line 227 "C:\\Haxe\\haxe\\std\\cs\\internal\\StringExt.hx"
							...
							#line 229 "C:\\Haxe\\haxe\\std\\cs\\internal\\StringExt.hx"
