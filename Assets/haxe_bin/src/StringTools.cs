...
public  class StringTools : global::haxe.lang.HxObject {
	public    StringTools(global::haxe.lang.EmptyObject empty){
		unchecked {
			#line 32 "C:\\Haxe\\haxe\\std\\StringTools.hx"
			{
			}
	...
	public static   string urlEncode(string s){
		unchecked {
			#line 52 "C:\\Haxe\\haxe\\std\\StringTools.hx"
	...
	public static   string urlDecode(string s){
		unchecked {
			#line 77 "C:\\Haxe\\haxe\\std\\StringTools.hx"
	...
	public static   string htmlUnescape(string s){
		unchecked {
			#line 117 "C:\\Haxe\\haxe\\std\\StringTools.hx"
	...
	public static   bool startsWith(string s, string start){
		unchecked {
			#line 131 "C:\\Haxe\\haxe\\std\\StringTools.hx"
	...
	public static   bool endsWith(string s, string end){
		unchecked {
			#line 148 "C:\\Haxe\\haxe\\std\\StringTools.hx"
	...
	public static   bool isSpace(string s, int pos){
		unchecked {
			#line 166 "C:\\Haxe\\haxe\\std\\StringTools.hx"
	...
	public static   string ltrim(string s){
		unchecked {
			#line 181 "C:\\Haxe\\haxe\\std\\StringTools.hx"
			return s.TrimStart();
		}
		#line default
	}
	...
	public static   string rtrim(string s){
		unchecked {
			#line 206 "C:\\Haxe\\haxe\\std\\StringTools.hx"
			return s.TrimEnd();
		}
		#line default
	}
	...
	public static   string trim(string s){
		unchecked {
			#line 228 "C:\\Haxe\\haxe\\std\\StringTools.hx"
			return s.Trim();
		}
		#line default
	}
	...
	public static   string lpad(string s, string c, int l){
		unchecked {
			#line 249 "C:\\Haxe\\haxe\\std\\StringTools.hx"
			if (( c.Length <= 0 )) {
				#line 250 "C:\\Haxe\\haxe\\std\\StringTools.hx"
				return s;
			}
			
			#line 252 "C:\\Haxe\\haxe\\std\\StringTools.hx"
			while (( s.Length < l )){
				#line 253 "C:\\Haxe\\haxe\\std\\StringTools.hx"
				s = global::haxe.lang.Runtime.concat(c, s);
			}
			
			#line 255 "C:\\Haxe\\haxe\\std\\StringTools.hx"
			return s;
		}
		#line default
	}
	...
	public static   string rpad(string s, string c, int l){
		unchecked {
			#line 271 "C:\\Haxe\\haxe\\std\\StringTools.hx"
			if (( c.Length <= 0 )) {
				#line 272 "C:\\Haxe\\haxe\\std\\StringTools.hx"
				return s;
			}
			
			#line 274 "C:\\Haxe\\haxe\\std\\StringTools.hx"
			while (( s.Length < l )){
				#line 275 "C:\\Haxe\\haxe\\std\\StringTools.hx"
				s = global::haxe.lang.Runtime.concat(s, c);
			}
			
			#line 277 "C:\\Haxe\\haxe\\std\\StringTools.hx"
			return s;
		}
		#line default
	}
	...
	public static   string replace(string s, string sub, string @by){
		unchecked {
			#line 298 "C:\\Haxe\\haxe\\std\\StringTools.hx"
			if (( sub.Length == 0 )) {
				#line 299 "C:\\Haxe\\haxe\\std\\StringTools.hx"
				return global::haxe.lang.StringExt.split(s, sub).@join(@by);
			}
			 else {
				#line 301 "C:\\Haxe\\haxe\\std\\StringTools.hx"
	...
	public static   string hex(int n, global::haxe.lang.Null<int> digits){
		unchecked {
			#line 319 "C:\\Haxe\\haxe\\std\\StringTools.hx"
			string s = "";
			string hexChars = "0123456789ABCDEF";
			do {
				#line 322 "C:\\Haxe\\haxe\\std\\StringTools.hx"
				s = global::haxe.lang.Runtime.concat(global::haxe.lang.StringExt.charAt(hexChars, ( n & 15 )), s);
				n = ((int) (( ((uint) (n) ) >> 4 )) );
			}
			while (( n > 0 ));
			#line 326 "C:\\Haxe\\haxe\\std\\StringTools.hx"
			if (digits.hasValue) {
				#line 327 "C:\\Haxe\\haxe\\std\\StringTools.hx"
				while (( s.Length < digits.@value )){
					#line 328 "C:\\Haxe\\haxe\\std\\StringTools.hx"
					s = global::haxe.lang.Runtime.concat("0", s);
				}
				
			}
			
			#line 329 "C:\\Haxe\\haxe\\std\\StringTools.hx"
			return s;
		}
		#line default
	}
	...
	public static   int fastCodeAt(string s, int index){
		unchecked {
			#line 354 "C:\\Haxe\\haxe\\std\\StringTools.hx"
	...
	public static   bool isEof(int c){
		unchecked {
			#line 379 "C:\\Haxe\\haxe\\std\\StringTools.hx"
			return ( c == -1 );
		}
		#line default
	}
